      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#000000]">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#111111] border border-[#333333] rounded-lg text-[#666666] font-medium cursor-not-allowed opacity-60 relative"
            >
              ...
              Login with Google
              <span className="ml-2 text-xs bg-[#333333] text-[#888888] px-2 py-0.5 rounded-full">Coming soon</span>
            </button>
